...
# Script per sostituire i link delle immagini con URL funzionanti reali

echo "🔧 Aggiornamento link immagini con URL reali..."

# 1. Aggiorna substance-detail.component.ts con link reali
cat > src/app/pages/substance-detail/substance-detail.component.ts << 'EOF'
...
echo "✅ substance-detail.component.ts aggiornato con link reali"

# 2. Aggiorna substances.component.ts con gli stessi link
cat > src/app/pages/substances/substances.component.ts << 'EOF'
...
echo "✅ substances.component.ts aggiornato con link reali"

# 3. Rimuovi onerror da HTML che cerca placeholder
echo "🔧 Aggiornamento HTML per rimuovere placeholder..."

# Aggiorna substances.component.html
sed -i 's/onerror="this.src=.*placeholder.png.*"//g' src/app/pages/substances/substances.component.html 2>/dev/null

# Aggiorna substance-detail.component.html  
sed -i 's/onerror="this.src=.*placeholder.png.*"//g' src/app/pages/substance-detail/substance-detail.component.html 2>/dev/null

echo "✅ Rimossi riferimenti a placeholder.png"

echo ""
echo "🎉 Aggiornamento completato!"
echo ""
echo "📋 Link immagini utilizzati (da Wikipedia):"
echo "  ✓ DMT: Struttura molecolare SVG"
echo "  ✓ LSD: Struttura 2D/3D"
echo "  ✓ Psilocybin: Struttura molecolare SVG"
echo "  ✓ MDMA: Struttura semplice"
echo "  ✓ Ketamine: Struttura skeletal"
echo "  ✓ Cannabis: Modello molecolare 3D"
echo "  ✓ Mescaline: Struttura SVG"
echo ""
echo "🚀 Ora esegui:"
echo "  1. Ferma ng serve (Ctrl+C)"
echo "  2. rm -rf .angular/cache"
echo "  3. ng serve"
echo "  4. Apri in incognito: http://localhost:4200/substances"
echo ""
echo "✅ NESSUN GLITCH! Le immagini sono vere e caricate da Wikipedia!"
echo ""
EOF
